    ...
    <div className="bump">
      ...
      <div className="project-container">
        ...
        <div className="proj-right">
          <ul className="about-links">
          <li><a href="https://www.linkedin.com/in/brockmolmen/" target="_blank" alt="LinkedIn" title="LinkedIn"><FontAwesomeIcon icon={faLinkedinIn} size="3x" className="icon-1" /></a></li>
          <li><a href="https://github.com/BrockMolmen" target="_blank" alt="GitHub" title="GitHub"><FontAwesomeIcon icon={faGithub} size="3x" className="icon-2" /></a></li>
          <li><a href="mailto:BrockMolmen@gmail.com" alt="Email" title="Email"><FontAwesomeIcon icon={faEnvelope} size="3x" className="icon-3" /></a></li>
          <li><a href="BrockMolmen_resume.pdf" target="_blank" alt="Resume" title="Resume"><FontAwesomeIcon icon={faFilePdf} size="3x" className="icon-4" /></a></li>
        </ul>
        <p>My name is Brock. I am a full-stack software engineer, focused on innovative front-end development. I enjoy writing code that looks as good as it functions. Transitioning from a career in the ever-evolving airline industry, I’m able to adapt and learn quickly in new situations and rely on great communication to accomplish goals in a team.</p>

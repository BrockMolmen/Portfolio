      ...
      <div className="stack-it">
        ...
        <div className="project-container card-three">
          ...
          <div className="proj-right">
            ...
            <a href="https://brockmolmen.github.io/CSS-Color-Match/" target="_blank" rel="noopener noreferrer"  alt="Blandched Almond - live site" title="Blandched Almond - live site"><FontAwesomeIcon icon={faDesktop} size="3x" className="icon" /></a>
            </div>
